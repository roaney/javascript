function verificar_idade() {
    ...
    if (idade < 1 || idade >= 130) {
        ...
        if (idade < 12) {
            document.querySelector('#dois img').src = 'menina.jpg'
        } else if (idade < 18) {
            document.querySelector('#dois img').src = 'menina_adolescente.jpg'
        } else if (idade < 60) {
            document.querySelector('#dois img').src = 'mulher_adulta.jpg'
        } else {
            document.querySelector('#dois img').src = 'mulher_idosa.jpg'
        }
